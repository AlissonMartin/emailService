...
public class GmailGateway implements EmailProviderGateway {
  ...
  public GmailGateway(String host, int port, String username, String password, String from) {
    this.host = host;
    this.port = port;
  ...
  public void sendEmail(String address, String subject, String body) {
    try {
      ...
      System.out.println("Enviado via Gmail para " + address);
    } catch (Exception e) {
